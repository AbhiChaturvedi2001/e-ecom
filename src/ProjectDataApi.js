const ProjectDataApi = [
  {
    ...
    projectDescription:
      "In this app We can search a github user id then fetch data from his account and show this app dashboard",
  },
  {
    id: 2,
    ...
    projectDescription:
      "In this app We can fetch real time weather data from third part Api server and we can use Fetch Api Method for accepting the promises and fulfill as well and show all the data onto the dashboard",
  },
  {
    id: 3,
    ...
    projectDescription:
      "In this app we can Split our expense when We all frinds are going outside or doing parties. We can also check the per person bill via splitter",
  },
  {
    id: 4,
    ...
    projectSourceCodeLink:
      "https://github.com/AbhiChaturvedi2001/Guess-my-Number",
    projectDescription:
      "In this app we can Split our expense when We all frinds are going outside or doing parties. We can also check the per person bill via splitter",
  },
];
